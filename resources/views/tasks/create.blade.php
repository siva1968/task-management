...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-gray-600">Add a new task to your project</p>
    </div>
        ...
        <form action="{{ route('tasks.store') }}" method="POST" class="p-6 space-y-6">
            ...
            <div class="border border-indigo-200 rounded-lg p-4 bg-indigo-50">
                ...
                <div id="subtasks-container" class="hidden">
                    ...
                    <p class="text-xs text-gray-500 mt-2 italic">Note: These are AI suggestions. You can create them manually after creating this task.</p>
                </div>
            </div>
